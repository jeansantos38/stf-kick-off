...
public class Parallel3 extends SeleniumTestBase {
    ...
    public void initialize(@Optional("http://localhost:4444/wd/hub") String seleniumHost,
        ...
        url = stubWebPage(NetworkHelper.retrieveLocalIPv4Address(networkInterface), 8059, urlToMock, "src/test/resources", "stfHtmlPlayground.html", 2000);
